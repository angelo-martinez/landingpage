...
},{"./../images/bg.jpg":[["bg.43bfd8b0.jpg","images/bg.jpg"],"images/bg.jpg"],"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var userSubscribed = urlParams.get('subscribed');

if (userName) {
  document.getElementById("js-hero-txt").innerHTML = "Welcome ".concat(userName, "!");
}
...
var displayDate = jsDate.toString().split(' ');
...
subForm.onsubmit = function (e) {
  e.preventDefault();
  var formName = document.getElementById("formnNme").value; // form submit via json post
  ...
  location.href = "?name=".concat(formName, "&subscribed=true");
};
